...
#include "com.inzori.salesforcechat.SalesforceChatModule.h"
	...
	namespace bindings {
		...
		BindEntry* TiModuleBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"com.inzori.salesforcechat.SalesforceChatModule", ::com::inzori::salesforcechat::SalesforceChatModule::bindProxy, ::com::inzori::salesforcechat::SalesforceChatModule::dispose}
			};
